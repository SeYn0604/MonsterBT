...
public class BossSkillTime : ActionNode
{
    [Header("스킬 설정")]
    public float skillDuration = 2.0f;
    
    [Header("스킬 정보")]
    [SerializeField] private string skillName = "시간 스킬";
    ...
    protected override void OnStart()
    {
        if (isUsed)
        {
            Debug.LogWarning($"BossSkillTime: {skillName}은 이미 사용되었습니다.");
            return;
        }
        ...
        Debug.Log($"BossSkillTime: {skillName} 시작");
    }
    ...
    protected override void OnStop()
    {
        ...
        Debug.Log($"BossSkillTime: {skillName} 종료");
    }
